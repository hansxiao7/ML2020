...
- In both models, when using generator or discriminator to predict values, <font color=red>**training=True**</font> is necessary to activate BatchNormalization layers. Batch normalization layers are important for a large model like GAN.
